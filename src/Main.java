...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            decode_args[11] = "msd2-bidirectional-fe" + " " + reordering_model_file_path;
            //decode_args[11] = "hierarchical";
    ...
    private static void decode(String[] args) throws Exception {
        ...
        System.out.println("przed load decoder");
        ...
        System.out.println("po load decoder");
